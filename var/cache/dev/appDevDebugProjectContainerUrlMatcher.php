    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/cart')) {
            ...
            if ('/cart/ajax-invoice' === $pathinfo) {
                return array (  '_controller' => 'AppBundle\\Controller\\CartController::ajaxInvoiceAction',  '_route' => 'cart_ajax_invoice_route',);
            }
            ...
            if ('/cart/invoice' === $pathinfo) {
                return array (  '_controller' => 'AppBundle\\Controller\\CartController::viewInvoiceAction',  '_route' => 'cart_invoice_route',);
            }
        ...
        if (0 === strpos($pathinfo, '/product')) {
            // product_view
            if ('/product/view' === $pathinfo) {
                return array (  '_controller' => 'AppBundle\\Controller\\ProductController::indexAction',  '_route' => 'product_view',);
            }

            // product_add
            if ('/product/add' === $pathinfo) {
                return array (  '_controller' => 'AppBundle\\Controller\\ProductController::addAction',  '_route' => 'product_add',);
            }
